...
export const DeanSchoolsSideNav: React.FC<DeanSchoolsSideNavProps> = ({ onNavItemClick }) => {
  ...
  const handleLogout = (): void => {
    ...
    toast.success("School Registry Session Terminated", {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-tight">
            <h4 className="text-xl font-black text-slate-800 tracking-tighter uppercase">
              School<span className="text-[#b91c1c]">Dean</span>
            </h4>
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
              Academic Registry Authority
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 border-t border-slate-100 bg-slate-50/50">
        <div className="flex items-center gap-3 p-3 bg-white rounded-2xl border border-slate-200 mb-4 shadow-sm">
          ...
          <div className="flex flex-col overflow-hidden">
            <span className="text-xs font-black text-slate-800 uppercase truncate">Dean of Schools</span>
            <div className="flex items-center gap-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Registry Sync On</span>
            </div>
          </div>
        </div>
...
export default DeanSchoolsSideNav;