...
export const AllUsers = () => {
  /* ================= API HOOKS ================= */
  // FIXED: Passed undefined to resolve TS assignability error
                  ...
                  <tr key={user.id as Key} className="hover:bg-red-50/50 transition-all group">
                    ...
                    <td className="px-10 py-6 text-right">
                       <div className="flex justify-end gap-2">
                          <button onClick={() => handleViewDetails(user)} className="p-2.5 bg-white text-slate-300 hover:text-red-800 rounded-xl shadow-sm border border-slate-100 transition-colors"><FaInfoCircle /></button>
                          <button onClick={() => handleUpdatePassword(user)} className="p-2.5 bg-white text-slate-300 hover:text-red-800 rounded-xl shadow-sm border border-slate-100 transition-colors"><FaKey /></button>
                          <button onClick={() => handleEdit(user)} className="p-2.5 bg-white text-slate-300 hover:text-red-800 rounded-xl shadow-sm border border-slate-100 transition-colors"><FaEdit /></button>
                          <button onClick={() => handleDelete(user.id)} className="p-2.5 bg-white text-slate-300 hover:text-red-800 rounded-xl shadow-sm border border-slate-100 transition-colors"><FaDeleteLeft /></button>
                       </div>
                    </td>
                  </tr>
                )) : (
